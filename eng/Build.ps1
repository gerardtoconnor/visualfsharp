...
try {
    ...
    if ($testDesktop) { # TODO: tests pass locally
    ...
    if ($testCoreClr) { # TODO: tests pass locally
    ...
    if ($testFSharpQA) { # TODO: some failures locally
    ...
    if ($testVs) {
        ...
        TestUsingNUnit -testProject "$RepoRoot\vsintegration\tests\UnitTests\VisualFSharp.UnitTests.fsproj" -targetFramework $desktopTargetFramework # hella failures locally
    }
